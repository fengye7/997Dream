...
public class DragRedCircle : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    private RectTransform rectTrans;
    private CanvasGroup canvasGroup;
    private Vector2 initialPosition;
    public delegate void DragRedEventHandler();
    public event DragRedEventHandler DragRed;
